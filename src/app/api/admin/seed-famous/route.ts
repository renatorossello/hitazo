...
import { searchTracks, importTracks, enrichWithGenres, SpotifyAuthError, type SpotifyTrack } from "@/lib/deck-engine";
import { FAMOUS_SONGS } from "@/lib/game/famous-songs";

/**
 * POST /api/admin/seed-famous
 * Siembra el set inicial de 50 canciones famosas al pool global.
 *
 ...
 * todo en needs_review. Host-only. Idempotente (upsert por spotify_uri).
 */
